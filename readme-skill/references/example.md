<!-- Gold-standard example README (Git City by @samuelrizzondev, https://github.com/srizzon/git-city). Study the structure, register, and level of detail — this is the target quality. -->
